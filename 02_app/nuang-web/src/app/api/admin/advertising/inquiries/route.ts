...
import { adminAdvertisingInquiryActionSchema } from "@/features/admin/admin-advertising-contract";
import {
  advertisingAdminActionError,
  manageAdvertisingInquiry,
...
export async function POST(request: Request) {
  ...
  const response = await manageAdvertisingInquiry({
    action: payload.data,
