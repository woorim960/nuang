    ...
    <div className="grid gap-5">
      ...
      <section className="grid gap-3">
        ...
        {openFreeTopicAssessments.map((assessment) => (
          ...
          >
            <div className="min-w-0">
              <p className="text-xs font-bold text-muted">{assessment.categoryLabel}</p>
        ...
        <div className="border-t border-line pt-4">
          ...
          <p className="mt-1 text-sm leading-6 text-muted">
            {plannedFreeTopicAssessments.map((assessment) => assessment.title).join(", ")}
            도 순차적으로 추가됩니다.
          </p>
        </div>
      </section>
      ...
      <section className="grid gap-3">
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-muted">
            무료로 즐기는 생활형 주제 검사예요. 공식 성향지도에는 반영하지 않아요.
          </p>
        </div>
          ...
          >
            <div className="min-w-0">
              ...
              <p className="mt-2 text-xs font-semibold text-muted">
                코어 미반영 · 서버 전송 없음 · 공유 닫힘 · {assessment.sensitivity}
              </p>
            </div>
            <ChevronRight aria-hidden="true" className="shrink-0 text-muted" size={18} />
          </Link>
