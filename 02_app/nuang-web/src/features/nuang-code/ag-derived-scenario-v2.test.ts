...
import iramcPacket from "../../../docs/research/trait-map-data-center-v2/generated/IRAMC_SCENARIO_REVIEW_V2.json";
import irgmcPacket from "../../../docs/research/trait-map-data-center-v2/generated/IRGMC_SCENARIO_REVIEW_V2.json";
import { engkqAgScenarioOverridesV2 } from "@/features/nuang-code/engkq-ag-scenario-overrides-v2";
import { iramcAgScenarioOverridesV2 } from "@/features/nuang-code/iramc-ag-scenario-overrides-v2";
...
const cases = [
  {
    ...
    packet: engkqPacket,
    base: enakqPacket,
    overrides: engkqAgScenarioOverridesV2,
  },
  {
    code: "IRAMC",
    packet: iramcPacket,
    base: irgmcPacket,
    overrides: iramcAgScenarioOverridesV2,
  },
] as const;

describe("A/G derived scenario packets v2", () => {
  ...
  it.each(cases)(
    "$code covers 72 canonical scenes and rewrites only ten A/G scenes",
