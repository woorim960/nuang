...
export const eramcFoundationClaimsV2 = buildFoundation(
  "ERAMC",
  "ERAMC는 사람들과 말하고 움직이며 확인된 사실과 직접 경험에서 생각을 시작하고, 상대 마음과 관계에 남을 영향을 살핀 뒤, 현재 조건에 맞춰 방법을 바꾸며, 부담스러운 상황에서도 감정이 비교적 천천히 커지는 조합으로 연구한다.",
);

export const ergkcFoundationClaimsV2 = buildFoundation(
  "ERGKC",
  "ERGKC는 사람들과 말하고 움직이며 확인된 사실과 직접 경험에서 원인과 해결할 부분을 찾고, 정한 계획을 이어가며, 부담스러운 상황에서도 감정이 비교적 천천히 커지는 조합으로 연구한다.",
);

export const ingkcFoundationClaimsV2 = buildFoundation(
  "INGKC",
  "INGKC는 혼자 생각을 정리하며 새로운 가능성과 의미를 넓히고, 관계 문제에서는 원인과 해결할 부분을 먼저 살핀 뒤, 정한 계획을 이어가며, 부담스러운 상황에서도 감정이 비교적 천천히 커지는 조합으로 연구한다.",
);

export const ingmqFoundationClaimsV2 = buildFoundation(
  "INGMQ",
  "INGMQ는 혼자 생각을 정리하며 새로운 가능성과 의미를 넓히고, 관계 문제에서는 원인과 해결할 부분을 먼저 살핀 뒤, 현재 조건에 맞춰 방법을 바꾸며, 불확실한 결과와 놓친 위험을 빠르게 알아차리는 조합으로 연구한다.",
);

export const iramqFoundationClaimsV2 = buildFoundation(
  "IRAMQ",
  "IRAMQ는 혼자 생각을 정리하며 확인된 사실과 직접 경험에서 생각을 시작하고, 상대 마음과 관계에 남을 영향을 살핀 뒤, 현재 조건에 맞춰 방법을 바꾸며, 불확실한 결과와 걱정을 빠르게 알아차리는 조합으로 연구한다.",
);
