...
import basePacket from "../../../docs/research/trait-map-data-center-v2/generated/ENAKQ_SCENARIO_REVIEW_V2.json";
import derivedPacket from "../../../docs/research/trait-map-data-center-v2/generated/INAKQ_SCENARIO_REVIEW_V2.json";
...
import { inakqEiScenarioOverridesV2 } from "@/features/nuang-code/inakq-ei-scenario-overrides-v2";

describe("INAKQ derived scenario packet v2", () => {
  ...
  it("inherits unchanged claims exactly and rewrites every E/I scene channel", () => {
    ...
    const overrideScenarioIds = new Set<string>(
      inakqEiScenarioOverridesV2.map((item) => item.scenarioId),
    );
