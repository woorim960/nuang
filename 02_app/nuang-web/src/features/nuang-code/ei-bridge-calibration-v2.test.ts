...
import audit from "../../../docs/research/trait-map-data-center-v2/generated/EI_BRIDGE_CALIBRATION_AUDIT_V2.json";

describe("E/I bridge calibration audit v2", () => {
  it("passes the structural cross-anchor calibration without publishing", () => {
    ...
    expect(audit.axis).toBe("SE_energy_and_expression");
  ...
  it("checks directional E/I language in concrete scenes", () => {
