...
export const urgentSteps = [
  "119 또는 112에 바로 전화하세요.",
  "가까운 사람에게 지금 위치와 위험한 상황을 알려주세요.",
  "약, 칼, 차량, 높은 곳처럼 위험한 것과 거리를 두고 사람이 있는 곳으로 이동하세요.",
];
...
export const helpResources: HelpResource[] = [
  ...
  },
  {
    ...
    title: "정신건강 상담전화",
    phone: "1577-0199",
    href: "https://www.mohw.go.kr/menu.es?mid=a10706040100",
    summary:
      "불안, 우울, 공황, 트라우마, 정신건강 어려움에 대해 상담을 받을 수 있어요.",
    availability: "24시간",
  ...
  },
  {
    ...
    summary:
      "청소년의 위기, 관계, 학교, 가정 문제를 전화·온라인 상담으로 연결해요.",
    availability: "24시간",
  ...
  },
  {
    ...
    summary:
      "가정폭력, 성폭력, 데이트폭력 등 여성폭력 피해 상담과 보호를 연결해요.",
    availability: "긴급 상담",
  ...
  },
  {
    ...
    summary:
      "복지, 긴급지원, 학대, 정신건강 상담 등 공공 지원 정보를 안내해요.",
...
export const helpBoundaries = [
  ...
  "이 허브는 진단이나 치료가 아니라, 필요한 도움을 빨리 받기 위한 정보 화면이에요.",
  "이 화면에서 선택한 내용은 계정이나 결과에 저장하지 않아요. 성향지도나 비교 리포트에도 반영하지 않아요.",
];

export const helpPrivacyNotice =
  "뉴앙은 이 화면에서 어떤 도움을 받았는지 계정에 저장하지 않아요. 전화나 외부 사이트 이용 기록은 사용 중인 기기와 해당 기관의 정책을 따릅니다.";
...
export const sourceLinks = [
  ...
  {
    label: "여성긴급전화 1366",
    href: "https://www.mogef.go.kr/cc/wcc/cc_wcc_f001.do",
  },
];
