...
import { ArrowLeft, Flag, MoreHorizontal, Pencil, Trash2 } from "lucide-react";
...
export function FeedMoreMenu({
  ...
  return (
    <div className={compact ? "relative" : "relative ml-auto"}>
      ...
      {open ? (
        <BottomSheet
          backdropLabel="더 보기 닫기"
          className="max-h-[88dvh] w-full max-w-[430px] px-3 pb-[calc(12px+env(safe-area-inset-bottom))] pt-2"
          dialogProps={{
