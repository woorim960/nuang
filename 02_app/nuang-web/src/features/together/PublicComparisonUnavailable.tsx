...
> = {
  stale: {
    ...
    body: "상대의 공개 범위가 바뀌어 이전 리포트를 그대로 열 수 없어요.",
    icon: RefreshCcw,
    statusLabel: "재확인 필요",
  ...
  disabled: {
    ...
    body: "현재 공개 범위 안에서 이 비교 리포트를 열 수 없어요.",
    icon: LockKeyhole,
    statusLabel: "접근 중단",
      ...
      <div className="border-y border-line py-4">
        <div className="flex items-start gap-3">
          <AlertTriangle
            ...
            size={18}
          />
          <p className="text-sm leading-6 text-muted">{copy.action}</p>
        </div>
      </div>
