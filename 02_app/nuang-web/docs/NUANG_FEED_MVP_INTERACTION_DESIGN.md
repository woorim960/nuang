...
- 검사 리포트 공유는 각 리포트 화면에서 시작하고, 피드 작성기에서는 글, 오늘의 질문, 투표만 노출한다.
- 오늘의 질문, 투표, 리포트 공유 preview를 피드의 핵심 재미 장치로 만든다.
...
| balance_game | 투표 | 질문과 선택지 중 하나를 고르고 업로드함 |
