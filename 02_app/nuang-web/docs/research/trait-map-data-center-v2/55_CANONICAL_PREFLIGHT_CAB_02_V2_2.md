...
| 정보 보존 합성                |   52 | 전문 편집 | 교정 대기 |
| 한 글자 이웃의 동일 문장 블록 |    2 | 0         | 교정 대기 |
| 과장·단정 표현                |    0 | 0         | 통과      |
| 진단·낙인 표현                |    0 | 0         | 통과      |
| 설명 없는 회피 표현           |    0 | 0         | 통과      |
...
1. 52개 정보 보존 합성 문장을 의미 손실 없이 하나의 쉬운 설명으로 다듬는다.
2. 2개 한 글자 이웃의 동일 문장 블록에서 실제 축 차이를 분명하게 만든다.
