# CAB-01 canonical 의미 보존 구조화 v2.1
...
서로 다른 두 원문 51쌍은 억지로 한 문장으로 합치지 않는다. 문장 유사도
최댓값이 0.361에 그쳐
...
1. 16개 표적 변형에서 반대 방향의 고유 설명을 근거 계보로 보강한다.
2. 8개 이웃 쌍을 나란히 읽어 한 글자 차이를 말로 설명할 수 있는지 확인한다.
3. 93개 전체에 7개 역할 검토를 기록한다.
