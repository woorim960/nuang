...
| 분류                                      | 개수 |
| ----------------------------------------- | ---: |
| DIRECTIONAL_MEANING_REWRITE_REQUIRED      |  170 |
| INFORMATION_PRESERVING_SYNTHESIS_REQUIRED |  431 |

같은 원문 집합을 다른 축 서명에서도 함께 쓰는 조합은
170개다. 이 항목은 단순히 두 문장을
