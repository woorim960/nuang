# canonical 문장 후보 큐와 건식 재생성 감사 v2.3
...
- 원문 후보가 하나뿐인 조합: 4
- 같은 조합에서 계보 문장이 충돌한 조합: 601
- 기존 원문 후보가 없는 조합: 0
- 기존 대표 초안에서 발견한 축 양쪽 같은 문장: 4
- 기존 원문 후보로 자동 해소한 충돌: 4
