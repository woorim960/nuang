...
G0는 완료됐다. G1의 다섯 근거 원장과 G2의 전체 원문 산출물은 갖춰졌지만, 체계적 검색 기록의 최종 검토가 남아 있어 `G1_ARTIFACTS_COMPLETE_REVIEW_PENDING`, `G2_ARTIFACT_COMPLETE_GATE_HELD`로 관리한다. G3–G7의 실제 외부 전문가·사용자·정량·제품 검토가 끝날 때까지 각 묶음은 연구 초안 상태를 유지한다.
