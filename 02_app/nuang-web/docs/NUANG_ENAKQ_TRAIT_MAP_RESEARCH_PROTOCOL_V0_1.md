...
- 두 번째 원문 초안: [`ENAKQ_MAP_DRAFT_PART2_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_MAP_DRAFT_PART2_V0_1.md)
- 두 번째 근거 원장: [`ENAKQ_EVIDENCE_LEDGER_PART2_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_EVIDENCE_LEDGER_PART2_V0_1.md)
- 세 번째 원문 초안: [`ENAKQ_MAP_DRAFT_PART3_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_MAP_DRAFT_PART3_V0_1.md)
- 세 번째 근거 원장: [`ENAKQ_EVIDENCE_LEDGER_PART3_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_EVIDENCE_LEDGER_PART3_V0_1.md)
- 네 번째 원문 초안: [`ENAKQ_MAP_DRAFT_PART4_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_MAP_DRAFT_PART4_V0_1.md)
- 네 번째 근거 원장: [`ENAKQ_EVIDENCE_LEDGER_PART4_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_EVIDENCE_LEDGER_PART4_V0_1.md)
- 다섯 번째 원문 초안: [`ENAKQ_MAP_DRAFT_PART5_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_MAP_DRAFT_PART5_V0_1.md)
- 다섯 번째 근거 원장: [`ENAKQ_EVIDENCE_LEDGER_PART5_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_EVIDENCE_LEDGER_PART5_V0_1.md)
- 전체 원문 감사: [`ENAKQ_FULL_DRAFT_AUDIT_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_FULL_DRAFT_AUDIT_V0_1.md)
- Claim registry·fixture 계약: [`ENAKQ_CLAIM_REGISTRY_AND_FIXTURE_CONTRACT_V0_1.md`](./trait-maps/ENAKQ/ENAKQ_CLAIM_REGISTRY_AND_FIXTURE_CONTRACT_V0_1.md)
- 외부 전문가 검토 패킷: [`enakq-map-v0.1`](./research/enakq-map-v0.1/README.md)

첫 묶음은 공백 제외 11,788자, 두 번째 묶음은 11,012자, 세 번째 묶음은 10,849자, 네 번째 묶음은 11,295자, 다섯 번째 묶음은 10,569자로 작성했다. 누적 원문은 공백 제외 55,513자이며 15개 장과 106개 문단 블록을 모두 완성했다. 현재 상태는 연구 초안이며, 외부 전문가 검토와 인지 인터뷰·정량 파일럿을 통과하기 전에는 운영 성향 지도의 확정 문구로 사용하지 않는다.

G0는 완료됐다. G1의 다섯 근거 원장과 G2의 전체 원문 산출물은 갖춰졌지만, 체계적 검색 기록의 최종 검토가 남아 있어 `G1_ARTIFACTS_COMPLETE_REVIEW_PENDING`, `G2_ARTIFACT_COMPLETE_GATE_HELD`로 관리한다. G7의 claim registry·fixture·중복 계약은 구현됐지만 실제 UI 합성 검수는 남아 있다. G3–G6의 외부 전문가·사용자·정량 검토와 G7의 제품 검수가 끝날 때까지 각 묶음은 연구 초안 상태를 유지한다.
